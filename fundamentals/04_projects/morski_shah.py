...
import random
print(
    f"Добре дошли в играта Морски Шах. Вие играете с X, а ботът с O. Ето възможните позиции. След всяко действие на бота, трябва да въведете на коя позиция искате да сложите X и да натиснете Enter\n     │1│2│3│\n     │4│5│6│\n     │7│8│9│\n\nкликнете върху конзолата и натиснете Enter за да започнете")
input()
first_pos = "бот"
score = [0, 0]
...
def bot_move():
    ...
    for i in range(9):
        if field[i] != 0:
            ...
            field[i] = 2
            if check_winner(
                    False) and random.random() >= 0.1:  # ако има такова движение, има 10% шанс да не го "забележи"
                winning_move = True
                break
            else:
                field[i] = 0
...
while True:  # този цикъл обхваща един рунд
    ...
    while True:  # този цикъл обхваща един ход
        ...
        if not check_winner(True):  # ако никой не е спечелил, изчакай действие
            ...
            input()
            break
#print(f"Добре дошли в играта Морски Шах. Вие играете с X, а ботът с O. Ето възможните позиции.
# След всяко действие на бота, трябва да въведете на коя позиция искате да сложите X и да натиснете Enter
# \n     │1│2│3│\n     │4│5│6│\n     │7│8│9│\n\n
# кликнете върху конзолата и натиснете Enter за да започнете")